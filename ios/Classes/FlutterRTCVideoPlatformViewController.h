...
@interface FlutterRTCVideoPlatformViewController : NSObject<FlutterPlatformView, FlutterStreamHandler, LKRTCVideoRenderer>
...
@property(nonatomic, strong) LKRTCVideoTrack* _Nullable videoTrack;
